programa
{
	...
	funcao inicio()
	{
		...
		para(inteiro i = 1; i <= quantidade_de_eleitores; i++)
		{
			...
			{
				batman++
				se(batman > maior_numero_de_votos)
				{
					maior_numero_de_votos = batman
			...
			{
				labareda++
				se(labareda > maior_numero_de_votos)
				{
					maior_numero_de_votos = labareda
			...
			{
				robim++
				se(robim > maior_numero_de_votos)
				{
					maior_numero_de_votos = robim
			...
			{
				batgirl++
				se(batgirl > maior_numero_de_votos)
				{
					maior_numero_de_votos = batgirl
			...
			{
				nulo++
				se(nulo > maior_numero_de_votos)
				{
					maior_numero_de_votos = nulo
